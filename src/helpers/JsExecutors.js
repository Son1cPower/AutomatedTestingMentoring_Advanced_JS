...
class JsExecutors {
    ...
    static async dragAndDrop(page, fromLocator, toLocator) {
        try {
            ...
            logger.info(`DragAndDrop from: handle-X:[${dragHandleBoundingBox.x}], handle-Y:[${dragHandleBoundingBox.y}] to: zone-X:[${dropZoneBoundingBox.x}], zone-Y:[${dropZoneBoundingBox.y}]`)
